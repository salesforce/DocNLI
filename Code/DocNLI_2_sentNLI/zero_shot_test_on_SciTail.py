...
CUDA_VISIBLE_DEVICES=3 python -u zero_shot_test_on_SciTail.py --task_name rte --do_train --do_lower_case --data_label DUC --num_train_epochs 20 --train_batch_size 32 --eval_batch_size 128 --learning_rate 1e-6 --max_seq_length 128 --seed 42

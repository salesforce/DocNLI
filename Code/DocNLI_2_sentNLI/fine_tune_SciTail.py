...
CUDA_VISIBLE_DEVICES=3 python -u fine_tune_SciTail.py --task_name rte --do_train --do_lower_case --num_train_epochs 5 --train_batch_size 32 --eval_batch_size 64 --learning_rate 1e-6 --max_seq_length 128 --seed 42

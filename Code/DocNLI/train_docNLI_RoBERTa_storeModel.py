...
CUDA_VISIBLE_DEVICES=0 python -u train_docNLI_RoBERTa_storeModel.py --task_name rte --do_train --do_lower_case --data_label DUC --num_train_epochs 20 --train_batch_size 4 --eval_batch_size 64 --learning_rate 1e-6 --max_seq_length 1024 --seed 42
